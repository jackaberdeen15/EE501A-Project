...
public:
	...
	//Note: The first input parameter, inp_signal_in_pin, must be connected to the "Echo" pin on the sensor.
	//The second input parameter, inp_signal_out_pin, must be connected to the "Trig" pin on the sensor. 
	//These are both DIGITAL pins.	
